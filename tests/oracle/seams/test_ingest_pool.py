...
(`apparatus/data/diamond-strain-sweep/01-what-this-data-is.md`). So this test reads from an
...
from programs.oracle.certification.cert import RefusalMode
from programs.oracle.accuracy.invariants import run_invariants
from programs.oracle.laws.residual import ResidualMap
from programs.oracle.state.state import CrystalState  # noqa: F401  (documents what a Frame carries)

pytest.importorskip("pymatgen", reason="the VASP reader needs pymatgen")

from programs.oracle.certification.cert import CertEvidence  # noqa: E402
from programs.oracle.seams.vasp import find_vasprun, read_frame  # noqa: E402
