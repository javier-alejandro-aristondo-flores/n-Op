...
sub-methods are unchanged, `arch-09 §9.1`). Canonical rows: `physics/library/formulas/registry-manifest.csv` 105–112
...
`Static/Thermodynamic` residuals (`arch-11 §11.1` item 17), from [deriv-defects] Part I.4:
