...
`programs.oracle.registry.elastic`, which was validated by reproducing the dataset's published
...
from programs.oracle.registry.elastic import green_lagrange_voigt, reference_cell
