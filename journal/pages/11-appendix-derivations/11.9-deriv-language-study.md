...
title: Implementation-language decision (`arch-18-open-decisions`, open item 4)
chapter: 11
chapter-name: appendix-derivations
tag: 11.9
status: draft
authority: supporting
content-hash: 20130b7c0d3c
canonical-for:
...
---
# Implementation-language decision (`arch-18-open-decisions`, open item 4)
...
- **2026-07-21 (partial reopen):** the language *picks* are open again — only the
  four-role polyglot shape stayed closed. [arch-18-open-decisions] open item 4 carries
