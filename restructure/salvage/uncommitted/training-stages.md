...
Canon owns the curriculum gating fractions: `arch-11-residuals §11.4.1`, settled as
`0.10 / 0.60 / 0.90` in `arch-18-open-decisions`. Those fractions govern which residual
