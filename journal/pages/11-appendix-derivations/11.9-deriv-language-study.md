...
title: Implementation-language decision (`arch-18-open-decisions`, open item 5)
chapter: 11
chapter-name: appendix-derivations
tag: 11.9
status: draft
authority: supporting
content-hash: 6c5f27b3f756
canonical-for:
...
---
# Implementation-language decision (`arch-18-open-decisions`, open item 5)
...
> is the part a later comparison should carry forward. [arch-18-open-decisions]
...
- **2026-07-21 (partial reopen):** the language *picks* are open again — only the
  four-role polyglot shape stayed closed. [arch-18-open-decisions] open item 5 carries
...
- **2026-06 (decision closed):** the recommendation here was adopted (commit ec52314-era) —
  ...
  in arch-18 "Closed decisions"; this file remains the research record behind it. Superseded
