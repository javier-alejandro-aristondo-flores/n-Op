...
### F.1 Schottky–Mott (now `barrier-from-workfunction-affinity`) (cheap path)
...
9. **Schottky–Mott (now `barrier-from-workfunction-affinity`) barrier** (cheap, F.1)
...
5. Schottky-Mott (now `barrier-from-workfunction-affinity`) + MIGS for Pt/H-diamond and Pt/O-diamond (the two thermally-stable diamond contact references)
