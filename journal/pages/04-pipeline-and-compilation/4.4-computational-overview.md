...
- **diff-tag:** D0 pure read (2) · DX no useful derivative — integer / categorical (8) · D1 smooth, gradient direct (91) · D2 adjoint-required-and-gated (25) · D3 implicit-function adjoint (3) · D4 relaxed, e.g. log-sum-exp soft-hull / Gumbel-Softmax (3). Vocabulary owned by `[impl-04-formulas]`.
