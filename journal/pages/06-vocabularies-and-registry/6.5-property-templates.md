...
instantiations. See `canonical-vocabularies §2` for the grouping and the
...
SelfConsistentRenormalizationOf(bare: BareSubstrate,
        ...
        (fixed-point structure shared across SCPH/SSCHA, GW self-energy, BSE
         iteration, polaron; emits IterativeResult cert evidence — residual-machinery §7)
