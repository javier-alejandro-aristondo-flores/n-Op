...
> (the canon chapters, the canon chapters, chapter 8) is canonical. Every claim
...
- **A certified specification base.** 58 pages with explicit topic ownership, 99
  ...
  (`journal/tools/`) covering twelve structural invariants and eleven mechanical sweeps, plus a third tool that calibrates them by planting a defect per check —
