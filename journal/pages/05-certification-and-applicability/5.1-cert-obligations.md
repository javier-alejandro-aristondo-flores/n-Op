...
substrate's sense (`representation-substrate §2`, §20.3 row for
...
`coupling-structure`). These values are the inputs `typeclass-alphabet` `Quantity.combineTol`
