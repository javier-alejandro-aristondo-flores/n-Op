...
- **A certified specification base.** 58 pages with explicit topic ownership, 99
  ...
  (`journal/tools/`) covering twelve structural invariants and twelve mechanical sweeps, plus a third tool that calibrates them — 29 probes, one per check, each planting a defect and asserting it fires —
