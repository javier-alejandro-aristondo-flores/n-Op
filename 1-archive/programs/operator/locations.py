...
against. Gate 4 set the precedent by reusing `programs.oracle.registry.elastic.green_lagrange_voigt`
...
#: Repository root. This file sits two levels below it: programs/operator/.
...
GATE4 = REPO / "apparatus" / "feasibility" / "gate-4-strain-sweep"
